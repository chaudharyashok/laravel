	...
	<div class="container">
		...
		<form method="post" enctype="multipart/form-data" action="" >
			...
			<div class="col-md-6">
				...
				<input type="text" class="form-control" name="pname" placeholder="Enter product name" id="inputFirstName">
			...
			<div class="col-md-6">
				...
				<textarea name="description" class="form-control" placeholder="text here your message"></textarea>
